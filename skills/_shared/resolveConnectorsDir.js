/**
 * Resolve the connector workspace root (any dir containing src/appmixer),
 ...
 *      src/appmixer — i.e. the workspace the agent is working in
...
export function resolveConnectorsDir(start = process.cwd()) {
    ...
    throw new Error(
        ...
        'inside a workspace (a dir containing src/appmixer).'
    );
}
