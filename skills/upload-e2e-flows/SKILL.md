...
node "$APPMIXER_SKILL_ROOT"/e2e-shared/scripts/appmixer-flow.mjs patch-accounts "$FLOW_ID" "$ACCOUNT_ID" "<vendor>.<connector>."
...
node "$APPMIXER_SKILL_ROOT"/e2e-shared/scripts/appmixer-flow.mjs list-accounts <vendor>:<connector>
